...
View my notebook with detailed steps here: [Job Market Analysis](Project-4 Data_Jobs_Analysis-Python/Result/1.Most in-demand data job roles.png).
Project-4 Data_Jobs_Analysis-Python/Result/1.Most in-demand data job roles.png
...
![Most in-demand data job roles](Project-4_Data_Jobs_Analysis-Python/Result/1.Most_in-demand_data_job_roles.png)    
